...
class GruposData {
    ...
    factory GruposData.fromRawJson(String str) => GruposData.fromJson(json.decode(str)[0]);
    ...
    factory GruposData.fromJson(Map<String, dynamic> json) => GruposData(
        ...
        nombre: json["nombre"],
        plantel: List<Plantel>.from(json["plantel"].map((x) => Plantel.fromJson(x))),
    );
...
class Carrera {
    ...
    factory Carrera.fromJson(Map<String, dynamic> json) => Carrera(
        ...
        tutor: json["tutor"],
        semestres: List<Semestre>.from(json["semestres"].map((x) => Semestre.fromJson(x))),
    );
